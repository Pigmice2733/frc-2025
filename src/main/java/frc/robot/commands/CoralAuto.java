...
public class CoralAuto extends SequentialCommandGroup {
  public CoralAuto(Drivetrain dvt, Vision vis, Elevator elv, Pivot pivot, GrabberWheel gbr, CoralGrabber crl) {
    addCommands(
        ...
        new DriveToTarget(dvt, vis, Units.inchesToMeters(17), Units.inchesToMeters(6.5), 0),
