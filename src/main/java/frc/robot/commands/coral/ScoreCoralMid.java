...
public class ScoreCoralMid extends SequentialCommandGroup {
  public ScoreCoralMid(CoralManipulator coral, Pivot arm) {
    addCommands(
        new SetPivotPosition(arm, PivotPosition.SCORE_L3),
        coral.outtake(),
